...
<body>
	<div class="manager" id="my_b_b">
		<span id="my_b_b" style="color: navy; display: inline-block;">관리자&nbsp;</span>회원가입
		승인 페이지
	</div>
	<div class="admin_list_no">
		<ul class="admin_list_no_ul">
			...
			<li class="admin_no" id="my_ll_b">성별</li>
			<li class="admin_date" id="my_ll_b">가입신청일</li>
			<li class="admin_date" id="my_ll_b">승인여부</li>
		</ul>
				...
				<div class="order_list1">
					...
					<div class="admin_img" id="my_l_b">
						<span><img style="width: 100%; height: auto;"
							src="./imgfile/${user.profileUrl}" alt="프로필"> </span>
					</div>
					<!-- 관리자 id -->
					...
					<div class="admin_gender" id="my_l_b">
						...
						<c:if test="${user.gender == 1}">남자</c:if>
						<c:if test="${user.gender == 2}">여자</c:if>
						</span>
					</div>
					<!-- 관리자 가입 신청일 -->
