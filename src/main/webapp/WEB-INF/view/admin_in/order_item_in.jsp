...
<body>
<form action="order_item_in.store" method="post" name="searchform">
	...
	<div class="admin_order_list">
		<div class="admin_order_header">
			...
			<!-- <button class="admin_order_btn" id="my_ll_w"
					onclick="location.href='./order_item_in_delete.store'">입고
					취소</button> -->
				<button class="admin_order_btn" id="my_ll_w"
					onclick="location.href='./order_item_in_write.store'">입고
					등록</button>
			</div>
			...
			<c:forEach var="whousing" items="${whousinginlist}">
